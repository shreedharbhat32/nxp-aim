...
extern PROTOBUF_INTERNAL_EXPORT_pose_5fwith_5fcovariance_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_PoseWithCovariance_pose_5fwith_5fcovariance_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_twist_5fwith_5fcovariance_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_TwistWithCovariance_twist_5fwith_5fcovariance_2eproto;
namespace synapse {
namespace msgs {
...
static void InitDefaultsscc_info_Odometry_odometry_2eproto() {
  ...
  {
    void* ptr = &::synapse::msgs::_Odometry_default_instance_;
    new (ptr) ::synapse::msgs::Odometry();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::synapse::msgs::Odometry::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3> scc_info_Odometry_odometry_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 3, 0, InitDefaultsscc_info_Odometry_odometry_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_odometry_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::synapse::msgs::Odometry, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::synapse::msgs::Odometry, header_),
  PROTOBUF_FIELD_OFFSET(::synapse::msgs::Odometry, child_frame_id_),
  PROTOBUF_FIELD_OFFSET(::synapse::msgs::Odometry, pose_),
  PROTOBUF_FIELD_OFFSET(::synapse::msgs::Odometry, twist_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::synapse::msgs::Odometry)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::synapse::msgs::_Odometry_default_instance_),
};

const char descriptor_table_protodef_odometry_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016odometry.proto\022\014synapse.msgs\032\014header.p"
  "roto\032\032pose_with_covariance.proto\032\033twist_"
  "with_covariance.proto\"\252\001\n\010Odometry\022$\n\006he"
  "ader\030\001 \001(\0132\024.synapse.msgs.Header\022\026\n\016chil"
  "d_frame_id\030\002 \001(\t\022.\n\004pose\030\003 \001(\0132 .synapse"
  ".msgs.PoseWithCovariance\0220\n\005twist\030\004 \001(\0132"
  "!.synapse.msgs.TwistWithCovarianceb\006prot"
  "o3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_odometry_2eproto_deps[3] = {
  &::descriptor_table_header_2eproto,
  &::descriptor_table_pose_5fwith_5fcovariance_2eproto,
  &::descriptor_table_twist_5fwith_5fcovariance_2eproto,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_odometry_2eproto = {
  false, false, descriptor_table_protodef_odometry_2eproto, "odometry.proto", 282,
  &descriptor_table_odometry_2eproto_once, descriptor_table_odometry_2eproto_sccs, descriptor_table_odometry_2eproto_deps, 1, 3,
...
void Odometry::InitAsDefaultInstance() {
  ::synapse::msgs::_Odometry_default_instance_._instance.get_mutable()->header_ = const_cast< ::synapse::msgs::Header*>(
      ::synapse::msgs::Header::internal_default_instance());
  ::synapse::msgs::_Odometry_default_instance_._instance.get_mutable()->pose_ = const_cast< ::synapse::msgs::PoseWithCovariance*>(
      ::synapse::msgs::PoseWithCovariance::internal_default_instance());
  ::synapse::msgs::_Odometry_default_instance_._instance.get_mutable()->twist_ = const_cast< ::synapse::msgs::TwistWithCovariance*>(
      ::synapse::msgs::TwistWithCovariance::internal_default_instance());
}
class Odometry::_Internal {
 public:
  static const ::synapse::msgs::Header& header(const Odometry* msg);
  static const ::synapse::msgs::PoseWithCovariance& pose(const Odometry* msg);
  static const ::synapse::msgs::TwistWithCovariance& twist(const Odometry* msg);
};
...
const ::synapse::msgs::PoseWithCovariance&
Odometry::_Internal::pose(const Odometry* msg) {
  return *msg->pose_;
}
const ::synapse::msgs::TwistWithCovariance&
...
Odometry::Odometry(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:synapse.msgs.Odometry)
}
Odometry::Odometry(const Odometry& from)
  ...
  if (from._internal_has_pose()) {
    pose_ = new ::synapse::msgs::PoseWithCovariance(*from.pose_);
  } else {
    pose_ = nullptr;
  }
  if (from._internal_has_twist()) {
    twist_ = new ::synapse::msgs::TwistWithCovariance(*from.twist_);
  } else {
    twist_ = nullptr;
  }
  // @@protoc_insertion_point(copy_constructor:synapse.msgs.Odometry)
}
...
Odometry::~Odometry() {
  // @@protoc_insertion_point(destructor:synapse.msgs.Odometry)
  SharedDtor();
...
void Odometry::Clear() {
// @@protoc_insertion_point(message_clear_start:synapse.msgs.Odometry)
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "synapse.msgs.Odometry.child_frame_id"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* Odometry::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:synapse.msgs.Odometry)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->child_frame_id().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "synapse.msgs.Odometry.child_frame_id");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:synapse.msgs.Odometry)
  return target;
}

size_t Odometry::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:synapse.msgs.Odometry)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:synapse.msgs.Odometry)
  GOOGLE_DCHECK_NE(&from, this);
  const Odometry* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Odometry>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:synapse.msgs.Odometry)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:synapse.msgs.Odometry)
    MergeFrom(*source);
  }
}

void Odometry::MergeFrom(const Odometry& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:synapse.msgs.Odometry)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (from.has_pose()) {
    _internal_mutable_pose()->::synapse::msgs::PoseWithCovariance::MergeFrom(from._internal_pose());
  }
  if (from.has_twist()) {
    _internal_mutable_twist()->::synapse::msgs::TwistWithCovariance::MergeFrom(from._internal_twist());
  }
}

void Odometry::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:synapse.msgs.Odometry)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:synapse.msgs.Odometry)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::synapse::msgs::Odometry* Arena::CreateMaybeMessage< ::synapse::msgs::Odometry >(Arena* arena) {
  return Arena::CreateMessageInternal< ::synapse::msgs::Odometry >(arena);
}
