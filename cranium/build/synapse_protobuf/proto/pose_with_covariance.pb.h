...
#ifndef GOOGLE_PROTOBUF_INCLUDED_pose_5fwith_5fcovariance_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_pose_5fwith_5fcovariance_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_pose_5fwith_5fcovariance_2eproto
...
struct TableStruct_pose_5fwith_5fcovariance_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_pose_5fwith_5fcovariance_2eproto;
namespace synapse {
namespace msgs {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::synapse::msgs::PoseWithCovariance* Arena::CreateMaybeMessage<::synapse::msgs::PoseWithCovariance>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace synapse {
namespace msgs {
...
class PoseWithCovariance PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:synapse.msgs.PoseWithCovariance) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "synapse.msgs.PoseWithCovariance";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_pose_5fwith_5fcovariance_2eproto);
    return ::descriptor_table_pose_5fwith_5fcovariance_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  public:
  void clear_pose();
  const ::synapse::msgs::Pose& pose() const;
  ::synapse::msgs::Pose* release_pose();
  ::synapse::msgs::Pose* mutable_pose();
  void set_allocated_pose(::synapse::msgs::Pose* pose);
  private:
  const ::synapse::msgs::Pose& _internal_pose() const;
  ::synapse::msgs::Pose* _internal_mutable_pose();
  public:
  void unsafe_arena_set_allocated_pose(
      ::synapse::msgs::Pose* pose);
  ::synapse::msgs::Pose* unsafe_arena_release_pose();
 ...
 private:
  ...
  ::synapse::msgs::Pose* pose_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_pose_5fwith_5fcovariance_2eproto;
};
// ===================================================================
...
inline const ::synapse::msgs::Pose& PoseWithCovariance::_internal_pose() const {
  const ::synapse::msgs::Pose* p = pose_;
  return p != nullptr ? *p : *reinterpret_cast<const ::synapse::msgs::Pose*>(
      &::synapse::msgs::_Pose_default_instance_);
}
inline const ::synapse::msgs::Pose& PoseWithCovariance::pose() const {
  // @@protoc_insertion_point(field_get:synapse.msgs.PoseWithCovariance.pose)
...
inline void PoseWithCovariance::unsafe_arena_set_allocated_pose(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:synapse.msgs.PoseWithCovariance.pose)
}
inline ::synapse::msgs::Pose* PoseWithCovariance::release_pose() {
...
inline ::synapse::msgs::Pose* PoseWithCovariance::unsafe_arena_release_pose() {
  // @@protoc_insertion_point(field_release:synapse.msgs.PoseWithCovariance.pose)
  
  ::synapse::msgs::Pose* temp = pose_;
  pose_ = nullptr;
  return temp;
}
inline ::synapse::msgs::Pose* PoseWithCovariance::_internal_mutable_pose() {
  
  if (pose_ == nullptr) {
    auto* p = CreateMaybeMessage<::synapse::msgs::Pose>(GetArena());
    pose_ = p;
  }
  return pose_;
}
inline ::synapse::msgs::Pose* PoseWithCovariance::mutable_pose() {
  // @@protoc_insertion_point(field_mutable:synapse.msgs.PoseWithCovariance.pose)
  return _internal_mutable_pose();
}
inline void PoseWithCovariance::set_allocated_pose(::synapse::msgs::Pose* pose) {
  ...
  pose_ = pose;
  // @@protoc_insertion_point(field_set_allocated:synapse.msgs.PoseWithCovariance.pose)
}
...
inline double PoseWithCovariance::covariance(int index) const {
  // @@protoc_insertion_point(field_get:synapse.msgs.PoseWithCovariance.covariance)
...
inline void PoseWithCovariance::set_covariance(int index, double value) {
  ...
  // @@protoc_insertion_point(field_set:synapse.msgs.PoseWithCovariance.covariance)
}
...
inline void PoseWithCovariance::add_covariance(double value) {
  ...
  // @@protoc_insertion_point(field_add:synapse.msgs.PoseWithCovariance.covariance)
}
...
PoseWithCovariance::covariance() const {
  // @@protoc_insertion_point(field_list:synapse.msgs.PoseWithCovariance.covariance)
...
PoseWithCovariance::mutable_covariance() {
  // @@protoc_insertion_point(field_mutable_list:synapse.msgs.PoseWithCovariance.covariance)
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_pose_5fwith_5fcovariance_2eproto
