...
#include "synapse_msgs/msg/detail/pixy_vector__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const synapse_msgs::msg::PixyVector & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  synapse_msgs::msg::PixyVector & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = synapse_msgs::msg::PixyVector;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const synapse_msgs::msg::PixyVector *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<synapse_msgs::msg::PixyVector *>(
    untyped_ros_message);
...
static size_t _PixyVector__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PixyVector(full_bounded, is_plain, 0);
...
get_message_type_support_handle<synapse_msgs::msg::PixyVector>()
{
  return &synapse_msgs::msg::typesupport_fastrtps_cpp::_PixyVector__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, synapse_msgs, msg, PixyVector)() {
  return &synapse_msgs::msg::typesupport_fastrtps_cpp::_PixyVector__handle;
}
