...
static const _TrafficStatus_type_support_symbol_names_t _TrafficStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, synapse_msgs, msg, TrafficStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, synapse_msgs, msg, TrafficStatus)),
  }
};
...
{
  return &::synapse_msgs::msg::rosidl_typesupport_cpp::TrafficStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, synapse_msgs, msg, TrafficStatus)() {
  return get_message_type_support_handle<synapse_msgs::msg::TrafficStatus>();
}
