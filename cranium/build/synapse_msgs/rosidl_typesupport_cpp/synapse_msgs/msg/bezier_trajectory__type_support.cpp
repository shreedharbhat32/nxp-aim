...
static const _BezierTrajectory_type_support_symbol_names_t _BezierTrajectory_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, synapse_msgs, msg, BezierTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, synapse_msgs, msg, BezierTrajectory)),
  }
};
...
{
  return &::synapse_msgs::msg::rosidl_typesupport_cpp::BezierTrajectory_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, synapse_msgs, msg, BezierTrajectory)() {
  return get_message_type_support_handle<synapse_msgs::msg::BezierTrajectory>();
}
