...
bool synapse_msgs__msg__bezier_curve__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("synapse_msgs.msg._bezier_curve.BezierCurve", full_classname_dest, 42) == 0);
  }
  synapse_msgs__msg__BezierCurve * ros_message = _ros_message;
  {  // time_stop
    PyObject * field = PyObject_GetAttrString(_pymsg, "time_stop");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->time_stop = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
  {  // x
...
{
  /* NOTE(esteve): Call constructor of BezierCurve */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("synapse_msgs.msg._bezier_curve");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BezierCurve");
  ...
  {  // time_stop
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->time_stop);
    {
      int rc = PyObject_SetAttrString(_pymessage, "time_stop", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
