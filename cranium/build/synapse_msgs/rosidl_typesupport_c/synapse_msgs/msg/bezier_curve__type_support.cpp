...
static const _BezierCurve_type_support_symbol_names_t _BezierCurve_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, synapse_msgs, msg, BezierCurve)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, synapse_msgs, msg, BezierCurve)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, synapse_msgs, msg, BezierCurve)() {
  return &::synapse_msgs::msg::rosidl_typesupport_c::BezierCurve_message_type_support_handle;
}
