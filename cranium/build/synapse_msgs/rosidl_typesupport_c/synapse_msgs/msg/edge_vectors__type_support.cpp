...
static const _EdgeVectors_type_support_symbol_names_t _EdgeVectors_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, synapse_msgs, msg, EdgeVectors)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, synapse_msgs, msg, EdgeVectors)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, synapse_msgs, msg, EdgeVectors)() {
  return &::synapse_msgs::msg::rosidl_typesupport_c::EdgeVectors_message_type_support_handle;
}
